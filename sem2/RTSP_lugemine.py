...
p_type = STREAM_URL.split("/")[-1].strip()
folder = Path("../pictures") / p_type
...
print(f"Pildid salvestatakse kausta: '{folder}' iga {SAVE_INTERVAL} sekundi järel.")
...
try:
    while True:
        ...
        if now - last_save_time > SAVE_INTERVAL:
            ...
            frame_count += 1
            last_save_time = now
            print(f"Salvestasin pildi kausta: {failinimi}")

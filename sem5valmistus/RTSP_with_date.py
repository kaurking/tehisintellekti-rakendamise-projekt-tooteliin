...
DEBUG_MODE = True  # Silumisreziim piltide salvestamiseks
...
DATE_OCR_METHOD = "vlm_single" # vlm_single, vlm_batch_independent, vlm_batch_consistent
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "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")
...
template_path = os.path.join(SCRIPT_DIR, "../template/medium_template.json")
...
barcode_data_path = os.path.join(SCRIPT_DIR, "../template/barcode_data.json")
